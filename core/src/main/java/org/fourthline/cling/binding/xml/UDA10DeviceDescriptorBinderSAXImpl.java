...
public class UDA10DeviceDescriptorBinderSAXImpl extends UDA10DeviceDescriptorBinderImpl {
    ...
    protected static class RootHandler extends DeviceDescriptorHandler<MutableDevice> {
        ...
        public RootHandler(MutableDevice instance, CoreSAXParser parser) {
    ...
    protected static class DeviceDescriptorHandler<I> extends CoreSAXParser.Handler<I> {

        public DeviceDescriptorHandler(I instance) {
            super(instance);
        }

        public DeviceDescriptorHandler(I instance, CoreSAXParser parser) {
            super(instance, parser);
        }
        ...
        public DeviceDescriptorHandler(I instance, CoreSAXParser parser, DeviceDescriptorHandler parent) {
