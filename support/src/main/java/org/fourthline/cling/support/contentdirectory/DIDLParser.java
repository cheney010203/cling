...
import org.fourthline.cling.support.lastchange.DLNASAXParser;
 ...
 * @author Mario Franco
 */
public class DIDLParser extends DLNASAXParser {
    ...
    protected RootHandler createRootHandler(DIDLContent instance, DLNASAXParser parser) {
    ...
    public class RootHandler extends Handler<DIDLContent> {
        ...
        RootHandler(DIDLContent instance, DLNASAXParser parser) {
