 ...
 */
public abstract class LastChangeParser extends DLNASAXParser {
    ...
    class RootHandler extends DLNASAXParser.Handler<Event> {

        RootHandler(Event instance, DLNASAXParser parser) {
    ...
    class InstanceIDHandler extends DLNASAXParser.Handler<InstanceID> {

        InstanceIDHandler(InstanceID instance, DLNASAXParser.Handler parent) {
